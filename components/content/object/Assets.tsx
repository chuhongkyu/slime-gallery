...
export function Assets(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <RigidBody type="fixed" scale={0.25} position={[0,0.2, 0]} colliders="trimesh" ccd>
    <group {...props} >
      ...
      <mesh castShadow rotation-y={Math.PI/2} geometry={nodes.Object_58.geometry} material={materials['Material.001']} position={[-10, 0.86, 25]} scale={[2.478, 0.111, 0.111]} />

      
      <group position={[0,0,-50]}>
      <mesh castShadow geometry={nodes.Object_34.geometry} material={materials['Material.001']} position={[0, -0.875, 5]} rotation={[0, 1.474, 0]} scale={0.333} />
      ...
      <mesh castShadow geometry={nodes.Object_60.geometry} material={materials['Material.001']} position={[0, 1.458, -8.522]} rotation={[0, -0.569, 0]} scale={0.49} />
      
      <mesh castShadow geometry={nodes.Object_64.geometry} material={materials['Material.001']} position={[0, 8.411, -14.66]} scale={[0.31, 5.576, 0.31]} />
      <mesh castShadow geometry={nodes.Object_66.geometry} material={materials['Material.001']} position={[0, 7.94, -21.468]} scale={[0.31, 5.576, 0.31]} />
      <mesh castShadow geometry={nodes.Object_68.geometry} material={materials['Material.001']} position={[0, 8.534, -15.231]} scale={[0.31, 5.576, 0.31]} />
      <mesh castShadow geometry={nodes.Object_70.geometry} material={materials['Material.001']} position={[0, 8.187, -20.318]} scale={[0.31, 5.576, 0.31]} />
      <mesh castShadow geometry={nodes.Object_72.geometry} material={materials['Material.001']} position={[0, 0.968, -10.45]} scale={[0.182, 3.273, 0.182]} />
      ...
      <mesh castShadow geometry={nodes.Object_76.geometry} material={materials['Material.001']} position={[0, 5.948, -24.079]} scale={[0.31, 5.576, 0.31]} />

      {/* 통 */}
      <mesh castShadow geometry={nodes.Object_78.geometry} material={materials['Material.001']} position={[0, 5.614, -28.252]} scale={[0.31, 5.576, 0.31]} />
