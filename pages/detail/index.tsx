    ...
    return (
      <>
        ...
        <main className="mx-auto max-w-[860px] p-10">
            <h1 className="text-lg text-black py-10">Upload Your GPTs Custom Slime</h1>
            ...
            <div className="flex flex-col gap-4 relative z-20 md:flex-row md:gap-7">
              <form className="relative z-10 flex flex-col items-center justify-center w-full md:w-[50%]" onSubmit={handleSubmit}>
                  <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-200 hover:bg-gray-300">
                      {file ? 
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <Image width={150} height={150} src={previewUrl} alt="preload"/>
                        <p className="text-xs text-black py-5">Click Upload Btn</p>
                      </div>
                      :
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                          ...
                          <p className="text-xs text-gray-500">PNG, JPG or Webp (MAX. 1024x1024px)</p>
                      </div>}
                      <input id="dropzone-file" type="file" className="hidden" onChange={handleFileChange} />
                  </label>
                  <p className="text-xs text-black py-5">{filename}</p>
              ...
              {url ? 
                ...
                : <div className="flex flex-col items-center justify-center w-full h-full">
                  <p className="text-black text-sm">Make Transparent...</p></div> 
              }
              </div>
            </div>
          <SlimeCarousel/>
